...
# # 5. Implement the Neural Network Class  <a class="anchor" id="5-bullet"></a> 
...
# # 6. Train the Neural Network <a class="anchor" id="6-bullet"></a> 
...
# # 7. Validate the neural network <a class="anchor" id="7-bullet"></a> 
